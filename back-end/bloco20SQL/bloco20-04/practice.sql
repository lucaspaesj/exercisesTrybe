...
('WALL-E', 'Pete Docter', 2008, 116);
# Exercício 2: O filme Procurando Nemo foi classificado em 6.8, fez 450 milhões no mercado interno e
# 370 milhões no mercado internacional. Insira as informações à tabela BoxOffice.
...
# Exercício 9: Altere a classificação da tabela BoxOffice para 6.0 de todos os filmes que lucraram menos de 300 milhões no
# mercado internacional e mais de 200 milhões no mercado interno.
SELECT * FROM BoxOffice;
UPDATE BoxOffice
SET rating = 6.0
