...
// const reduceNumbers = evenNumbers.reduce((acc, num)=>acc+num);
// console.log(reduceNumbers);

const sumEvens = numbers.reduce((acc, num) => ((num % 2 === 0) ? acc + num : acc), 0);
...
const studentsReport = (students) => students.map((student)=>({
    name: student.nome,
    materia: student.materias.reduce(getBestClass).name,
}))

console.log(studentsReport(estudantes));